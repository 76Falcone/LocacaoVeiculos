...
<body>
  <div class="container">
    <div class="card">
      ...
      <p>Os dados do veículo foram salvos corretamente no sistema Novare.</p>
      <div class="actions">
        <a href="html/listarVeiculos.html" class="btn-primary">Ir para Frota</a>
        <a href="html/cadastroVeiculo.html" class="btn-secondary">Cadastrar Outro</a>
      </div>
    </div>
  </div>
</body>
